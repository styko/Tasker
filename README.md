...
1. Start application with `java -jar target/tasker-0.1.jar server config.yml`
...
mvn clean install
java -jar target/tasker-0.1.jar db migrate config.yml
java -jar target/tasker-0.1.jar server config.yml
...
eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJkYXRhNGoiOiJ7XCJ1c2VybmFtZVwiOlwianVzdC11c2VyXCIsXCJwcml2aWxlZ2VzXCI6W1wiVVNFUlwiXX0ifQ==.01gBXLp9mz6HRn4rJX+5J4mrygbSBfi2QDDC6oPmLhI=
